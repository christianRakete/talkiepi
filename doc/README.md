...
go get github.com/christianRakete/talkiepi

cd $GOPATH/src/github.com/christianRakete/talkiepi
...
```
cp /home/mumble/gocode/src/github.com/christianRakete/talkiepi/conf/systemd/mumble.service /etc/systemd/system/mumble.service
